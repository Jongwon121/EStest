const quizData = [
  ...
  },
  {
    ...
    answer: "O",
    explanation:
      "비상정지 버튼은 쉽게 식별할 수 있도록 빨간색으로 되어있습니다.",
  },
  {
    question: "에스컬레이터에서 우측으로 서서 걸어가는 것이 좋다.",
    answer: "X",
    explanation:
      "에스컬레이터에서는 안전을 위해 걷지 말고 서서 이용해야 합니다.",
  },
  {
    ...
    <div className='quiz-container'>
      ...
      <div className='question-container'>
        ...
        <div className='options'>
          <button
            className={`option-button o-button ${
              answer === "O"
                ? quizData[currentQuestion].answer === "O"
                  ? "correct"
                  : "incorrect"
                : ""
            }`}
          ...
          <button
            className={`option-button x-button ${
              answer === "X"
                ? quizData[currentQuestion].answer === "X"
                  ? "correct"
                  : "incorrect"
                : ""
            }`}
